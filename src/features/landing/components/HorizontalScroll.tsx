...
const businessUnits = [
  {
    ...
    pitch:
      'Wir verwandeln Ihre bestehende Datenbank in eine aktive Verkaufsmaschine. Unser System automatisiert Follow-ups, generiert Termine aus dem Bestand und sorgt dafür, dass kein Kunde vergessen wird.',
  ...
  },
  {
    ...
    pitch:
      'Intelligente KI-Sprachbots, die Anrufe 24/7 entgegennehmen, qualifizieren und weiterleiten. Ihr digitaler Empfang, der niemals schläft – 100% Erreichbarkeit, 0% Stress.',
  ...
  },
  {
    ...
    pitch:
      'Wir bauen Webseiten, die Besucher gezielt in Anfragen verwandeln. Wir kombinieren technisches Verständnis für Ihre Branche mit hochwertigem Design für einen zukunftssicheren Außenauftritt.',
    ...
    linkPath: ROUTES.ENGAGE.MARKETING,
  },
  {
    id: 'solutions',
    ...
    pitch:
      'Ob Lead-Scraping oder komplexe Schnittstellen: Wir bauen die technische Brücke, die Ihnen die manuelle Arbeit abnimmt, damit sich Ihr Team voll auf den Abschluss konzentrieren kann.',
    ...
    linkPath: ROUTES.ENGAGE.WORKFLOWS,
  },
];
        ...
        <motion.div style={{ x }} className="flex gap-8 pl-8 md:pl-20 items-center">
          ...
          <div className="min-w-[300px] md:min-w-[400px] text-white pr-10">
            ...
            <p className="text-slate-400 text-lg">
              Vier spezialisierte Einheiten, eine Mission: Ihr Unternehmen digital nach vorne zu
              bringen. Wischen Sie, um Lösungen zu entdecken.
            </p>
          ...
          {businessUnits.map((unit) => (
            ...
            >
              ...
              <div className="absolute inset-0 z-0">
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-t ${unit.color} opacity-20 mix-blend-multiply group-hover:opacity-40 transition-opacity duration-700`}
                />
