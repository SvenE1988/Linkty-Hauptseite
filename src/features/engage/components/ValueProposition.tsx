...
const sections = [
  {
    ...
    icon: AlertCircle,
    image:
      'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?q=60&w=800&dpr=2&auto=format&fit=crop',
    reverse: false,
  },
  {
    ...
    icon: Zap,
    image:
      'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=60&w=800&dpr=2&auto=format&fit=crop',
    reverse: true,
  },
  {
    kicker: 'Das Ergebnis',
    ...
    icon: TrendingUp,
    image:
      'https://images.unsplash.com/photo-1553877522-43269d4ea984?q=60&w=800&dpr=2&auto=format&fit=crop',
    reverse: false,
  },
];
