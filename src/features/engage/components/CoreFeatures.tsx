...
const features = [
  {
    ...
    title: 'CRM',
    description:
      'Kontakte intelligent verwalten statt nur archivieren. Automatische Erinnerungen, Segmentierung und Follow-up-Strategien.',
    link: ROUTES.ENGAGE.CRM,
  ...
  },
  {
    ...
    title: 'Kommunikation',
    description:
      'WhatsApp, E-Mail und Telefon in einer Inbox. Omnichannel-Kommunikation für echte Kundennähe.',
    link: ROUTES.ENGAGE.KOMMUNIKATION,
  ...
  },
  {
    ...
    title: 'Marketing',
    description:
      'Kampagnen und Lead-Nurturing, die funktionieren. Automatisierte Drip-Kampagnen für Bestandskunden.',
    link: ROUTES.ENGAGE.MARKETING,
  ...
  },
  {
    ...
    title: 'Team',
    description:
      'Aufgaben delegieren, Verantwortlichkeiten nachverfolgen. Ihr Team arbeitet synchronisiert und effizient.',
    link: ROUTES.ENGAGE.TEAM,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-engage-teal"
              >
                <div
