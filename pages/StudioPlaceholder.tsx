      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
        ...
        <section className="pt-32 pb-20 px-4">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 text-purple-800 rounded-full text-sm font-semibold mb-8">
            ...
            <p className="text-2xl md:text-3xl text-purple-600 font-bold mb-6">
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-2xl p-8 md:p-12 mb-16">
            ...
            <div className="mb-12 bg-purple-50 rounded-xl p-8">
              <h3 className="text-2xl font-bold text-purple-900 mb-4">Die Lösung ist bereits verfügbar</h3>
            ...
            {/* Hinweis */}
            <div className="bg-gray-50 border-l-4 border-purple-500 p-6 rounded-r-lg mb-12">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <button
                ...
                className="px-10 py-4 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition-all shadow-lg transform hover:-translate-y-1"
              >
                Kostenlose Erstberatung buchen
              </button>
              <button
                onClick={() => setShowCalendar(true)}
                className="px-10 py-4 border-2 border-purple-600 text-purple-600 font-bold rounded-lg hover:bg-purple-50 transition-all"
              >
            ...
            <p className="text-center text-gray-600 mt-8">
              Oder direkt anfragen: <a href="mailto:studio@linkty.de" className="text-purple-600 hover:underline font-semibold">studio@linkty.de</a>
            </p>
          </div>
        </section>
        ...
        <footer className="bg-gray-900 text-white py-12 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex gap-6 justify-center text-sm">
              <Link to="/" className="hover:text-purple-400 transition-colors">Startseite</Link>
