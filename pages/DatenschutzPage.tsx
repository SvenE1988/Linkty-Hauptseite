      ...
      <div className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <h3 className="text-xl font-bold text-brand-navy mt-6 mb-3">Datenschutz</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Linkty – Eine Marke der Erkens Holding GmbH<br />
              Haubenkopfstr. 12<br />
              76189 Karlsruhe<br />
              Telefon: +49 721 95279401<br />
            ...
            <h3 className="text-xl font-bold text-brand-navy mt-6 mb-3">Server-Log-Dateien</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-bold text-brand-navy mt-6 mb-3">Kontaktformular</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-bold text-brand-navy mt-6 mb-3">Widerspruchsrecht</h3>
            <p className="mb-4">
              Sie haben das Recht, jederzeit gegen die Verarbeitung Ihrer personenbezogenen Daten
              Widerspruch einzulegen. Wir werden die Verarbeitung Ihrer personenbezogenen Daten
            ...
            <h3 className="text-xl font-bold text-brand-navy mt-6 mb-3">Beschwerderecht</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Auf dieser Website nutzen wir GoHighLevel für Kontaktformulare und Terminbuchungen.
              Dabei werden Ihre eingegebenen Daten (Name, E-Mail, Telefonnummer, etc.) an die
              Server von GoHighLevel übermittelt und dort verarbeitet. Die Datenverarbeitung
              erfolgt auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO).
            </p>
            <p className="mb-4">
              Weitere Informationen zum Datenschutz bei GoHighLevel finden Sie unter:<br />
              <a href="https://www.gohighlevel.com/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-brand-teal hover:underline">
